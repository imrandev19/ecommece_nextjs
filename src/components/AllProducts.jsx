        ...
        <Container>
            <div className='grid grid-cols-4 gap-x-6'>
                <div className='flash'>
                    ...
                    <div className='flex items-center gap-3 py-3 pl-3 pr-1 border-1 border-[#E4E7E9]'>
                    ...
                    <div className='flex items-center gap-3 py-3 pl-3 pr-1  my-4 border-1 border-[#E4E7E9]'>
